...
function Temperatures({ setCity, stats }) {
  const handleCityChange = (e) => {
    setCity(e.target.value);
  };
  return (
    <>
      {/* <h1 className="bg-zinc-400">Weather Report</h1> */}
      
      <div className="flex align-middle justify-center">
      {/* <img class="h-1 w-20" src="https://cdn.pixabay.com/photo/2017/06/04/19/20/weather-2371967_960_720.png" alt="ChitChat Logo"/> */}
